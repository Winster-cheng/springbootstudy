          ...
          <div className="log-wrap">
            <h3 className="log-header">
              ...
              <Icon
                ...
                component={logup}
                style={{right: expandLevel ? "28px" : "8px",display: expandLevel != 2 ? "inline-block":"none"}}
                className="log-header-icon log-header-icon_top"
              />
              <Icon
                onClick={() => this.expand(false)}
                component={logdown}
                style={{right: (expandLevel == 1 || 2) ? "8px" : "28px",display: expandLevel ? "inline-block":"none"}}
                ...
                <ul>
                  {
                    logs.map((log,index) => 
                      ...
                      >
                        <Icon component={this.statuslogo[log.status.id]} className="log-status" />
                        {log.time}
                      </li>)
                   }
                </ul>
