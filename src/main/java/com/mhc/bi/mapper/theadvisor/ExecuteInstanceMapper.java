...
public interface ExecuteInstanceMapper {
    @Insert("insert into executeinstance (parent_id,start_time,end_time,gmt_create,status,log_link) values(#{executeInstance.parentId},#{executeInstance.startTime},#{executeInstance.endTime},#{createTime},#{executeInstance.status},#{executeInstance.logLink})")
